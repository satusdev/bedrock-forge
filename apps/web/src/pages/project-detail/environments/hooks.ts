...
export function useWpUsersQuery(projectId: number, envId: number, enabled: boolean) {
...
export function useDbCredentialsQuery(projectId: number, envId: number, enabled: boolean) {
...
export function useSaveDbCredentialsMutation(projectId: number, envId: number) {
	...
	return useMutation({
		mutationFn: (data: unknown) => environmentsApi.saveDbCredentials(projectId, envId, data),
		onSuccess: () => {
...
export function useDeleteEnvironmentMutation(projectId: number) {
	const qc = useQueryClient();
	return useMutation({
		mutationFn: (envId: number) => environmentsApi.deleteEnvironment(projectId, envId),
		onSuccess: () => {
			qc.invalidateQueries({ queryKey: ['environments', projectId] });
