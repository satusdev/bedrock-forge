...
import { useEnvironmentsQuery, useServersQuery, useDeleteEnvironmentMutation } from './hooks';
...
export function EnvironmentsTab({ projectId }: { projectId: number }) {
	...
	const { data: environments = [], isLoading, refetch } = useEnvironmentsQuery(projectId);
