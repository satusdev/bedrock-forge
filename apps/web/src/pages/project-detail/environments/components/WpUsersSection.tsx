...
import { Users, ChevronUp, ChevronDown, Loader2, LogIn, Copy, ExternalLink } from 'lucide-react';
...
export function WpUsersSection({
	...
	async function handleQuickLogin(userId: number) {
		...
		try {
			const result = await environmentsApi.generateQuickLogin(projectId, envId, userId);
