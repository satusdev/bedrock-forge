...
export function useScanMutation(envId: number, options?: {
	...
	return useMutation({
		...
		onSuccess: (data) => {
			toast({
				...
				description: 'Results will appear automatically when the scan completes.',
			});
...
export function useUpdateAllMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }) => void;
}) {
	return useMutation({
...
export function useRemovePluginMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }, slug: string) => void;
}) {
	return useMutation({
...
export function useUpdatePluginMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }, slug: string) => void;
}) {
	return useMutation({
		mutationFn: ({ slug, skipSafetyBackup }: { slug: string; skipSafetyBackup: boolean }) =>
...
export function useChangeConstraintMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }, slug: string) => void;
}) {
	return useMutation({
...
export function useToggleStatusMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }, params: { slug: string; status: 'active' | 'inactive' }) => void;
}) {
	return useMutation({
		mutationFn: ({ slug, status, skipSafetyBackup }: { slug: string; status: 'active' | 'inactive'; skipSafetyBackup: boolean }) =>
			pluginsApi.togglePluginStatus(envId, slug, { active: status === 'active', skipSafetyBackup }),
...
export function useMigrateToComposerMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }, slug: string) => void;
}) {
	return useMutation({
		mutationFn: ({ slug, skipSafetyBackup }: { slug: string; skipSafetyBackup: boolean }) =>
...
export function useUninstallCustomMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }) => void;
}) {
	return useMutation({
...
export function useUpdateCustomMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }) => void;
}) {
	return useMutation({
		mutationFn: (customPluginId: number) =>
...
export function useInstallCustomMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }) => void;
}) {
	return useMutation({
		mutationFn: (customPluginId: number) =>
...
export function useCheckVersionsMutation(envId: number, options?: {
	onSuccess?: () => void;
}) {
...
export function useComposerReadMutation(envId: number, options?: {
	onSuccess?: (data: { jobExecutionId: number; bullJobId: string }) => void;
}) {
	return useMutation({
...
export function useSavePluginUpdateSchedule(envId: number, options?: {
...
export function useDeletePluginUpdateSchedule(envId: number, options?: {
	onSuccess?: () => void;
}) {
	const qc = useQueryClient();
	return useMutation({
