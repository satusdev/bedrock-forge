        ...
        >
                ...
                {searchResults.map((p) => (
                  ...
                  >
                    <div className="space-y-0.5">
                      ...
                      <span className="text-[10px] bg-muted px-1 py-0.5 rounded text-muted-foreground ml-1.5 font-mono">
                        {p.slug}
                      </span>
          ...
          <div className="border-t pt-3 space-y-4">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="composer">
                      Composer-managed (composer.json)
                    </SelectItem>
                    <SelectItem value="manual">
                      Manual installation (WP-CLI direct)
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                placeholder={
                  workflow === "composer" ? "e.g. ^8.0 or 8.1.2" : "e.g. 8.1.2"
                }
                value={version}
            ...
            <div className="flex items-center space-x-2 pt-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setSkipSafetyBackup(checked as boolean)
                }
                disabled={mutation.isPending}
              />
              <label
