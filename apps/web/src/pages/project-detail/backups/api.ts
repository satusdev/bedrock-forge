...
export const backupsApi = {
	getBackups: async (envId: number): Promise<{ items: Backup[]; total: number }> => {
	...
	cancelBackupExecution: async (execId: number): Promise<{ cancelled: boolean }> => {
	...
	upsertBackupSchedule: async (envId: number, payload: BackupScheduleForm): Promise<unknown> => {
