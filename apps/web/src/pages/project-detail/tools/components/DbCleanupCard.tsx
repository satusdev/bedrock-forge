...
export function DbCleanupCard({
  ...
  const cleanupMutation = useMutation({
    ...
    onError: () =>
      toast({ title: "Failed to queue cleanup job", variant: "destructive" }),
  });
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          Remove post revisions, expired transients, spam comments, and orphaned
          postmeta
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex flex-wrap gap-3">
          ...
          >
            {cleanupMutation.isPending && cleanupMutation.variables?.dryRun ? (
