...
export function InvoiceDetailPage() {
	...
	return (
		<div className='space-y-6 max-w-3xl'>
			{/* Back */}
			<Button variant='ghost' size='sm' className='-ml-1' onClick={() => navigate('/invoices')}>
				<ArrowLeft className='h-4 w-4 mr-1.5' />
				All Invoices
			</Button>
			...
			<div className='flex flex-wrap items-start justify-between gap-4'>
				<div>
					<div className='flex items-center gap-3 flex-wrap'>
						...
						<Badge variant={STATUS_VARIANT[invoice.status]} className='text-sm capitalize'>
				...
				<div className='px-6 py-5 grid grid-cols-1 sm:grid-cols-2 gap-6 border-b'>
					...
					<div className='space-y-2 text-sm'>
						...
						<div className='flex justify-between'>
							...
							<span className='font-medium'>{fmtPeriod(invoice.period_start, invoice.period_end)}</span>
						</div>
						<div className='flex justify-between'>
						...
						<div className='flex justify-between'>
							...
							<span className='text-muted-foreground'>{fmtDate(invoice.created_at)}</span>
						</div>
					</div>
				</div>
