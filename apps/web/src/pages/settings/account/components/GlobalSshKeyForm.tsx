          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Authentication fallback for server connections.
                </CardDescription>
              </div>
            </div>
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="p-4 rounded-xl bg-muted/30 border border-dashed border-muted-foreground/20">
            <p className="text-sm text-muted-foreground leading-relaxed">
              Used as a fallback when no per-server SSH key is explicitly set.
              The key is stored using AES-256 encryption and is never exposed
              via API responses.
            </p>
          </div>
