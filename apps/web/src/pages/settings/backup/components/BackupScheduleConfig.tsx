...
import { useBackupSchedule, useSaveBackupScheduleMutation, useDeleteBackupScheduleMutation } from '../hooks';
...
export function BackupScheduleConfig() {
	...
	const handleSave = () => {
		saveSchedule.mutate({
			...
			...(scheduleFreq === 'monthly' ? { day_of_month: scheduleDayOfMonth } : {}),
			enabled: scheduleEnabled,
			retention_count: scheduleRetentionCount ? Number(scheduleRetentionCount) : null,
			retention_days: scheduleRetentionDays ? Number(scheduleRetentionDays) : null,
		});
	};
