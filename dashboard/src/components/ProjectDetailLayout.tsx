		...
		<div className='space-y-6'>
			...
			<div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6'>
				<div className='flex items-center justify-between'>
					...
					<div className='flex items-center space-x-4'>
						...
						<div className='text-center'>
							<div
								className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getHealthStatusColor(projectData.health_score)}`}
							>
				...
				{projectData.environments &&
					Object.keys(projectData.environments).length > 0 && (
						<div className='mt-6 pt-6 border-t border-gray-200'>
							<h3 className='text-sm font-medium text-gray-900 mb-3'>
								Environments
							</h3>
							<div className='flex flex-wrap gap-3'>
								{Object.entries(projectData.environments).map(
									([envType, env]: [string, any]) => (
										<div
											key={envType}
			...
			<div className='bg-white rounded-lg shadow-sm border border-gray-200'>
				...
				{activeTab === 'wordpress' && (
					<WordPressManager project={projectData} />
				)}
