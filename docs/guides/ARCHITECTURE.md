...
`GET /search` powers the Cmd/K command palette. The search module combines
static route definitions with Prisma-backed projects, environments, clients,
and servers, then returns typed deep links for resource and project-tab
navigation.
